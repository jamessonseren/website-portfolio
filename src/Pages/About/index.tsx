        ...
        <section className="about-section">
            ...
            <div className='author-info'>
                <p>Hello, my name is Jamesson Seren, a 30-year-old Brazilian Fullstack developer. <br/><br/>
                    ...
                    Currently, I am studying Information Systems and work with various technologies such as ReactJS, NextJS, NodeJS, and relational and non-relational databases, among others.
